...
#Get any of the training csv in the ./data folder and get the best ones
df = pd.read_csv("./data/trainingResults.csv")

##Prepare all the enemies and evo's data and settings for the runs later
bestEnemy2E1 = [0]*10
bestEnemy5E1 = [0]*10
bestEnemy8E1 = [0]*10
...
#Run the enemies, make sure you set the nNeurons equal to the trainings!!!
##And here we will run and filter the data to be stored in the testResults.csv
allRuns = {
    "0_2":bestEnemy2E1,
    "0_5":bestEnemy5E1,
    "0_8":bestEnemy8E1,
...
df.to_csv("./data/testRestults.csv",index=False)